;(function () {
	...
	var sliderMain = function() {
	  	...
	  	$('#fh5co-home .flexslider .video').css('height', $(window).height());	
	  	$(window).resize(function(){
	  		$('#fh5co-home .flexslider .video').css('height', $(window).height());	
	  	});
	...
	var mainMenuSticky = function() {
		...
		$('.js-sticky').waypoint(function(direction) {
		  	...
		  	offset: function() { return -$(this.element).height() + 22; }
			// 여기 상단 수정 후 여기도 수정해야함 기본값 69
		});
				...
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {
					...
					setTimeout(function() {
						$('#fh5co-home .to-animate').each(function( k ) {
							...
							setTimeout ( function () {
								el.addClass('fadeInUpMainText animated');
							},  k * 200, 'easeInOutExpo' );
